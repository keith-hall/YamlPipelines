...
def syntax_event_listener(syntax, scope_path_patterns):
    ...
    """
    def decorator(cls):
        cls.SCOPE_PATH_PATTERNS = scope_path_patterns
        cls._applicable_syntax = syntax
        ...
        cls.on_load = on_load
        cls.on_save_async = on_save_async
        cls.set_syntax_if_filepath_applicable = set_syntax_if_filepath_applicable
